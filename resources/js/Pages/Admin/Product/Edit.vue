            ...
            >
                <FormField class="image-container">
                    <div class="flex">
                        <BaseButton
                            label="Image Upload"
                            class="w-32 h-10 inline-block"
                            :route-name="
                                route('admin.product.image', props.product.id)
                            "
                            :icon="mdiAppleKeyboardCaps"
                        />
                        <BaseButton
                            label="Image Edit"
                            class="w-32 h-10 inline-block ml-4"
                            :route-name="
                                route(
  ...
  >
    <swiper-slide v-for="plu in time" :key="plu.id">
      <div class="grid grid-cols-3 gap-4 my-4 swiper-draggable">
        <div
          v-for="(image, index) in props.product.image_product"
          :key="image.id"
        ...
        >
          <div class="relative">
            ...
            <div class="absolute top-2 right-2">
              <div
                @click="destroyImage(image.id, image.rank)"
              ...
              >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.payment_deadline_minutes"
                        >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.estimated_market_price"
                        >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.auction_duration_minutes"
                        >
                            {{ form.errors.weight }}
                        </div>
                    </FormControl>
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.registration_amount"
                        >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.required_bidders"
                        >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.opening_bid_amount"
                        >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.product_details"
                        >
                ...
                >
                    ...
                    >
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.auction_start"
                        >
