...
function submitProfileImage() {
    profileImage.post(route('admin.account.image.store'))
}
</script>
    ...
    <LayoutAuthenticated>
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiAccount" title="Profile" main>
                <BaseButton :route-name="route('admin.dashboard')" :icon="mdiArrowLeftBoldOutline" label="Back"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <CardBox title="Edit Profile" :icon="mdiAccountCircle" form
                    @submit.prevent="profileForm.post(route('admin.account.info.store'))">
                    <FormField label="Name" help="Required. Your name" :class="{ 'text-red-400': profileForm.errors.name }">
                    ...
                    <FormField label="Email" help="Required. Your e-mail"
                ...
                <CardBox title="Edit Image" :icon="mdiAccountCircle" form
                    @submit.prevent="submitProfileImage">

                    <FormField label="Email" help="Required. Your photo"
                        :class="{ 'text-red-400': profileForm.errors.email }">
                ...
                <CardBox title="Change Password" :icon="mdiLock" form @submit.prevent="
